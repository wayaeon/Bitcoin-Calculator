...
class CoinGeckoAPI {
  constructor() {
    ...
    this.csvPath = path.join(process.cwd(), 'public', 'BTC Price History.csv')
  }

  async fetchBitcoinHistoricalData(days = 365) {
    try {
  ...
  async shouldUpdateData(maxAgeHours = 24) {
